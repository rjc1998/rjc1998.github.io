...
Visitors can select 25 post-cutoff CISA KEV questions, compare Llama 3 8B with
and without RAG at fixed `k=5`, reveal the benchmark answer, and inspect up to
three of the five retrieved passages.
...
The original Resident Evil demo remains available under
`archive/resident_evil/demo/`.
